package it.smallcode.smallpets.v1_18.pets;
/*
...
public class Monkey extends Pet {
    ...
    public Monkey(String id, Player owner, Long xp, Boolean useProtocolLib) {
        ...
        super.abilities.add(new SpeedBoostInBiomeAbility(new LinkedList<>(Arrays.asList(Biome.JUNGLE, Biome.SPARSE_JUNGLE, Biome.BAMBOO_JUNGLE)), 0.01D, 0.05D));
    }
